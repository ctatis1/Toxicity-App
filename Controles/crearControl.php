                                ...
                                <form action="validarCrearControl.php" method="post">  
                                 ...
                                 <div class="row">                              
                                  <div class="form-group col-lg-6">
                                    ...
                                    <input type="date" class="form-control" value="2001-01-01" min="1930-01-01" id="FechaInicio" name="FechaInicio" placeholder="Ingrese la fecha en la que inició el control">
                                    <p></p>
                                  </div>                                  
                                  <div class="form-group col-lg-6">
                                    <label for="exampleInputEmail1" class="font-weight-bold">Fecha de Finalización</label>
                                    <input type="date" class="form-control" value="2001-01-01" min="1930-01-01" id="FechaFinal" name="FechaFinal" placeholder="Ingrese la fecha en la que finalizó el control">
                                    <p></p>
                                    </div>   
                                  </div> 
                                  <div class="row">                              
                                ...
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 d-flex">
                                            <button class="btn btn-primary w-100 align-self-center"><a class="text-light">Crear Control</a></button>
                                          </div>  
                                    </div>
                                    </div>                                      
                                </form>
